...
def train_model(train_loader, val_loader, device, num_epochs, learning_rate, batch_size, weight_decay):
    ...
    #after doing 5 fold cv on aept, use the best hps in path to load weights
    PATH='/data/users2/jwardell1/dcgan-project/models/aept_5cv_bestlr_bestbs_bestwd_Fbestfold.pth'
    encoder.main.load_state_dict
...
plt.title('Fine Tuning 5-Fold CV - Test Accuracy Across Folds')
plt.savefig('../models/FT5CV_box_plot.png')
...
if best_model_state is not None:
    PATH = '../models/ft5cv_{}_{}_{}_F{}.pth'.format(learning_rate, batch_size, weight_decay, fold)
